			...
			if(window.plus) {
				...
				mui.plusReady(function() {
					...
					if(_self._ConnectionType == "None connection" || _self._ConnectionType == "undefined") {
						...
						_self.postData("http://192.168.1.97:8008/App/GetToken",obj, CallBackSuccess, CallBackError, callBackFinish);
					}
				})
			} else {
				_self.postData("http://192.168.1.97:8008/App/GetToken",obj, CallBackSuccess, CallBackError, callBackFinish);
